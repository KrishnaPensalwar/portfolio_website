...
function ExperienceCard({
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-2 h-4 w-4 rounded-full border-2 border-slate-900 bg-white dark:border-white dark:bg-slate-950" />
      <div className="absolute left-[7px] top-6 h-full w-0.5 bg-slate-300 dark:bg-slate-700" />

      <div className="glass-card mb-8 p-6 transition-all hover:border-slate-300 dark:hover:border-slate-600">
